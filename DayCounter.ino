...
void drawDaysString() {
  ...
  // g_epd.SetFrameMemory(IMAGE_DATA, 16, 6, 96, 53, true /* from_progmem */);
  // g_epd.SetFrameMemory(IMAGE_DATA, 16, 61, 96, 53, true /* from_progmem */);
  // g_epd.SetFrameMemory(IMAGE_DATA, 16, 116, 96, 53, true /* from_progmem */);

  // g_epd.SetFrameMemory(IMAGE_DATA_days, 8, 172  , 48, 73, true /* from_progmem */);
  DaysPaint::PaintDaysToFrameMemory(123, &g_epd);
  g_epd.DisplayFrame();
  // g_epd.ClearFrameMemory(0xFF);
  ...
  // g_epd.SetFrameMemory(IMAGE_DATA, 5, 5, 80, 41, true /* from_progmem */);
  // g_epd.DisplayFrame();
